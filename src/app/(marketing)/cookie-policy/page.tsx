...
export const metadata: Metadata = {
  ...
  description:
    "Cookie policy and website tracking guidelines for BriefVault cloud platform by Brightwave Digital Products LLP.",
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none space-y-8 text-foreground/90">
            <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
              ...
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                This Cookie Policy explains how <strong>BriefVault</strong> (owned by <strong>Brightwave Digital Products LLP</strong>) uses cookies and similar session storage technologies to recognize you when you visit our website at {siteConfig.url} or sign into your legal intelligence dashboard.
              </p>
            </div>
